...
export default function App() {
  ...
  */
   useEffect(() => {
    ...
    // NewWaveイベントがコントラクトから発信された時に、情報を受け取ります
    if (window.ethereum) {
    ...
    <div className="mainContainer">
      ...
      <div className="dataContainer">
        <div className="header">
          <span role="img" aria-label="hand-wave">👋</span> Hi,Johnny!
        </div>

        <div className="bio">
          イーサリアムウォレットを接続して、hogehogeメッセージを送ろう<span role="img" aria-label="hand-wave">👋</span><span role="img" aria-label="shine">✨</span>
        </div>
